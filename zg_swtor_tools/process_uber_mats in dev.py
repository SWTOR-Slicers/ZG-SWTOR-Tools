...
# from .create_material_AnimatedUV import create_material_AnimatedUV
            ...
            if ob.type == "MESH":
                ...
                for mat_slot in ob.material_slots:
                    ...
                    if (
                        ...
                        # finding only the Uber, Creature and similar ones.
                        ...
                        if matxml_derived == "AnimatedUV":
                            # create_material_AnimatedUV(mat.name)
                            pass
                        
                        elif  matxml_derived in ["Uber", "EmissiveOnly", "Glass"]:
