...
class ZGSWTOR_OT_shaders_io_copier(bpy.types.Operator):
    bl_idname = "zgswtor.shaders_io_copier"
...
def register():    
    bpy.utils.register_class(ZGSWTOR_OT_shaders_io_copier)

def unregister():
    bpy.utils.unregister_class(ZGSWTOR_OT_shaders_io_copier)
