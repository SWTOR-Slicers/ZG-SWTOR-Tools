...
class ZGSWTOR_OT_quickscale(bpy.types.Operator):
    ...
    bl_description = "Changes bones' rotation mode from SWTOR's default quaternion to any other one. Works in both whole armature objects or specific bones while in Pose Mode."
