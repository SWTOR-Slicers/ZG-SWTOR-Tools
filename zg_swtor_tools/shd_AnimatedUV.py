...
def create_AnimatedUV_nodegroup(material_datablock):
    ...
    if not node_tree1:
        ...
        input = node_tree1.inputs.new('NodeSocketFloat', 'animTexTint1')
        if hasattr(input, 'attribute_domain'):
            input.attribute_domain = 'POINT'
        if hasattr(input, 'default_value'):
            input.default_value = 0.0
        ...
        if hasattr(animtexuvscrollspeed1_004_1, 'location'):
            animtexuvscrollspeed1_004_1.location = (-740.0, 480.0)
        ...
        if hasattr(separate_xyz_001_1, 'location'):
            separate_xyz_001_1.location = (-880.0, 480.0)
        ...
        if hasattr(group_input_002_1.outputs[7], 'default_value'):
            group_input_002_1.outputs[7].default_value = 0.0
        ...
        if hasattr(group_input_005_1.outputs[9], 'hide'):
            group_input_005_1.outputs[9].hide = False
        ...
        if hasattr(group_input_003_1.outputs[7], 'default_value'):
            group_input_003_1.outputs[7].default_value = 0.0
        ...
        node_tree1.links.new(combine_xyz_1.outputs[0], separate_xyz_001_1.inputs[0])
        node_tree1.links.new(group_input_1.outputs[7], combine_xyz_1.inputs[0])
        node_tree1.links.new(group_input_1.outputs[7], combine_xyz_1.inputs[1])
        node_tree1.links.new(group_input_1.outputs[7], combine_xyz_1.inputs[2])
    ...
    if hasattr(swtor_animateduv_shader_0.inputs[7], 'default_value'):
        swtor_animateduv_shader_0.inputs[7].default_value = 0.0
