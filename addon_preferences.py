...
class addonPreferences(bpy.types.AddonPreferences):
    ...
    default_custom_shaders_blendfile = os.path.join(os.path.dirname(__file__), "rsrc" + os.sep + "Custom SWTOR Shaders.blend")
    ...
    def draw(self, context):
        ...
        swtor_custom_shaders_blendfile_path = bpy.context.preferences.addons[__package__].preferences.swtor_custom_shaders_blendfile_path
        # Default one
...
class ZGSWTOR_OT_reset_custom_shaders_prefs_to_internal(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        context.preferences.addons[__package__].preferences["swtor_custom_shaders_blendfile_path"] = default_custom_shaders_blend_filepath
